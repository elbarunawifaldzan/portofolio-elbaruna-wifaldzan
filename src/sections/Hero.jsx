...
function Typewriter({ dark }) {
  ...
  return (
    <motion.p
      ...
      className={`text-xl md:text-2xl font-semibold tracking-wide mt-3 h-8 ${dark ? 'text-gray-400' : 'text-gray-500'}`}
    >
      {displayed}
      {/* Blinking cursor */}
    ...
    <section id="hero" className={`relative min-h-screen flex flex-col overflow-hidden ${bg} transition-colors duration-300`}>
      ...
      <div className="relative flex flex-col items-center w-full min-h-screen pt-20 pb-4" style={{ zIndex: 3 }}>
        ...
        >
          ...
          <div className="hidden lg:flex items-end justify-between w-full px-12 gap-4">
            {/* Left — Quote */}
            <motion.div
