      ...
      <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-start">
        ...
        <div>
          ...
          >
            ...
            <p className="label">Education History</p>
          </motion.div>
            ...
            <div className="space-y-8 md:space-y-10 pl-8">
              {educations.map((edu, i) => (
                ...
                >
                  ...
                  />
                  {edu.year && <p className="label mb-1">{edu.year}</p>}
                  <div className="flex items-center gap-3 mb-1">
                    {edu.logo && (
                      <img src={edu.logo} alt={edu.institution}
                        className="w-7 h-7 md:w-8 md:h-8 rounded-lg object-contain shrink-0" />
                    )}
                    <h3 className={`text-sm md:text-base font-bold uppercase tracking-wider ${t}`}>
                      {edu.degree}
                    </h3>
                  </div>
        ...
        >
          <div className="overflow-hidden rounded-2xl max-w-sm relative">
            <img
              src="/img/Education/img-06.jpeg"
              alt="Education"
              className={`w-full h-auto object-contain transition-all duration-700 ${dark ? 'grayscale-0' : 'grayscale'}`}
            />
            <div className={`absolute inset-0 bg-gradient-to-t ${dark ? 'from-black/70' : 'from-white/70'} via-transparent to-transparent`} />
          </div>
        </motion.div>
